      ...
      </div>
      {
        messages.map(message => {
          ...
          if (prev === message.userId) {
            return <Message message={message} showUser={false}/>
          } else {

           prev = message.userId
            return <Message message={message} showUser={true}/>
          }
        })
      }
      {/*{*/}
